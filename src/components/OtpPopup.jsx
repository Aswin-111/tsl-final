...
//     const inputField = inputRefs[index].current;
...
//     } else if (!value && index === 0) {
//       // On the first input, if backspace is pressed and the current input is empty, prevent the default behavior (browser might go back)
