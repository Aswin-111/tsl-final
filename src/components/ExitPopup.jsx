...
const ExitPopup = ({allPopupState,setAllPopupState}) => {
              ...
              <div className="row pop-up">
               ...
               Do you want to exit
                  ...
                  <div className="col-12 pop-btn d-flex justify-content-around align-items-center">
                      ...
                      <button className="edit"  onClick = {()=>{setEdit(false);setAllPopupState(false)}}>OK</button>
                      <button className="ok" onClick = {()=>location.reload()}>Cancel</button>
                  </div>
              </div>
          </div>
      </div>
