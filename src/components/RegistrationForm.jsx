    ...
    return ()=>{
        ...
        const { register, handleSubmit, formState : {errors}, setValue } = useForm({
         ...
         function onSubmit(data) {
            ...
            const updated_data = {...data, dob:`${year}-${month}-${day}`, languages:selectedLanguages, country_code : selectedCountryPhonecode, country:country[0].name, gender: selectedGender, specialRemarks: remark,ref_id:ref_id }
        ...
        <span className="show-error">{errors.specialRemarks.message}</span>
                ...
                <div className="col-12 form-input-container">
                    <div className="row h-100">
                       ...
                       {exitpopup && <ExitPopup setAllPopupState = {setAllPopupState} allPopupState = {allPopupState} />}
