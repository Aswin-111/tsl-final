...
const RegistrationForm = ({
  ...
  const [isprivacyChecked, setIsPrivacyChecked] = useState(null);
  ...
  const schema = yup.object().shape({
    ...
    phone: yup
      ...
      .max(9999999999999, "Enter a valid phone number")
      .positive()
      .integer(),
    reference: yup
      .string()
  ...
  function onSubmit(data) {
    ...
    let ref_id = "";
    try {
      ref_id = location.href.split("?")[1].split("=")[1];
    } catch (err) {
      console.log(err);
    }
    // console.log(country,selectedGender,location.href.split("?")[1].split("=")[1],"line")
    ...
    const updated_data = {
      ...
      specialRemarks: remark,
      ref_id: ref_id,
    };

    if (!doErr && !langErr && isprivacyChecked) {
  ...
  return (
    <form
      className="w-100 m-0 form-container-wrapper"
    ...
    >
      <div className="row g-4 container-fluid form-parent-container mx-0">
        <div className="col-12">
          <div className="row gx-4">
            <div className="col-md-6 gy-4 form-input-container">
              <input
                type="text"
                className="fname form-input-field w-100 h-100"
                {...register("firstName")}
                placeholder="First name"
                style={{ border: errors.firstName ? "2px solid red" : "none" }}
              />
              {errors.firstName && (
                <span className="show-error ">{errors.firstName.message}</span>
              )}
            </div>
            <div className="col-md-6 gy-4 form-input-container">
              <input
                type="text"
                className="lname form-input-field w-100 h-100"
                {...register("secondName")}
                placeholder="Last name"
                style={{ border: errors.secondName ? "2px solid red" : "none" }}
              />
              {errors.secondName && (
                <span className="show-error ">{errors.secondName.message}</span>
              )}
            </div>
          </div>
          ...
          <div className="row gx-4">
            <div className="col-md-6 gy-4 form-input-container">
              <input
                type="text"
                className="email form-input-field w-100 h-100"
                {...register("email")}
                placeholder="Email"
                style={{
                  border:
                    errors.email || existsError.flag === "email"
                      ? "2px solid red"
                      : "none",
                }}
              />
              {errors.email && (
                <span className="show-error ">Enter a valid email</span>
              )}
            </div>
            <div className="col-md-6 gy-4 form-input-container">
              ...
              {doErr && (
                <span className="show-error ">Select your date of birth</span>
              )}
          ...
          <div className="row gx-4">
            <div className="col-md-6 gy-4 form-input-container">
              <select
                className="form-input-field w-100 h-100"
                ref={countryRef}
                // {...register("country")}
            ...
            <div className="col-md-6 gy-4 phone-code-n-number form-input-container">
              <div className="row h-100 g-0 d-flex justify-content-between">
                  ...
                  <div className="h-100 pe-3">
                    <div className="country-flag form-input-field w-100 h-100 d-flex justify-content-center align-items-center">
                      <img
                        ...
                        style={{ border: "0.5px solid #d9d9e3" }}
                ...
                <div className="col-7 h-100 gx-0">
                  <input
                    ...
                    style={{
                      border:
                        errors.phone || existsError.flag === "phone"
                          ? "2px solid red"
                          : "none",
                    }}
                  />
              ...
              {errors.phone && (
                <span className="show-error text-end">
          ...
          <div className="row gx-4">
            <div className="col-md-6 gy-4 form-input-container">
              <div
                className="form-input-field w-100 h-100 d-flex justify-content-around"
                style={{ border: errors.reference ? "2px solid red" : "none" }}
              >
                ...
                <div className="reference-name d-flex flex-column justify-content-center align-items-center">
                  Social media
                  <input
                    className="reference-radio-button"
              ...
              {errors.reference && (
                <span className="show-error ">{errors.reference.message}</span>
              )}
            </div>

            <div className="col-md-6 gy-4 form-input-container">
              <div
                className="multiselect language form-input-field w-100 h-100"
                style={{ border: langErr && "2px solid red" }}
              >
                {/* Multiselect */}
        ...
        <div className="col-12 form-input-container-textarea">
          <div className="row h-100">
            <div className="col-12">
              ...
              <textarea
                className="form-input-field w-100 h-100 special-remarks"
                style={{
                  border: errors.specialRemarks ? "2px solid red" : "none",
                }}
                name="specialRemarks"
                value={remark}
                rows={isExpanded ? 4 : 1}
        ...
        {/* <span className="col-12 form-input-container d-flex align-items-center">
            ...
            <span>I have read and agree to Thasmai Starlife's <a href="">Privacy Policy</a></span>
        </span> */}
        ...
        <div className="col-12 form-input-container">
          <div className="row h-100">
            <div className="col-12">
              ...
              <input
                className="submit form-input-field w-100 h-100"
                type="submit"
                value="Submit"
                onClick={() => {
                  check();
      ...
      {confirm && (
        <ConfirmationPopup
          ...
          details={updateddata}
          otp={setOtp}
          setUsers={setUserStatusState}
          setUserStatusErr={setExistsError}
      ...
      {otppopup && (
        <OtpPopup
          setEdit={setConfirm}
          toggleResend={setResend}
          resendState={resendEnabled}
          otpstatus={invalidOtp}
          setInvalidOtp={setInvalidOtp}
          otp={setOtp}
          details={updateddata}
          setSuccessToggle={setSuccess}
          setSuccessPageData={setSuccessData}
          setAllPopupState={setAllPopupState}
          allPopupState={allPopupState}
        />
      )}
